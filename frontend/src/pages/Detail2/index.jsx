...
export default function Detail() {
  ...
  const options = [{value:'ALL', label:'ALL'}, {value:'LEGENDARY', label:'LEGENDARY'}, {value:'EPIC', label:'EPIC'}, {value:'RARE', label:'RARE'}, {value:'UNCOMMON', label:'UNCOMMON'}, {value:'COMMON', label:'COMMON'}]
