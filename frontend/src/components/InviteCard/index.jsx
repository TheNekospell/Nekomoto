...
export default function InviteCard({
	...
	const createEmpower = () => {
		...
		if (navigator.clipboard) {
			navigator.clipboard
				.writeText("https://game.nekomoto.xyz/detail2?addr=" + address)
				.then(() => {
			...
			<div className="invite-card">
				...
				<Row justify="center">
					<div
						...
						style={{
							marginTop: isMobile ? "12px" : "56px",
							marginBottom: "24px",
						}}
					>
						{"Invite 5 friends to help you get the Master‘s Box (" +
							chestEmpower.length +
							"/5)"}
					</div>
				</Row>
						...
						{chestEmpower[0] ? (
							<div>
								...
								<div className="friend-text">
									{chestEmpower[0].slice(0, 4) +
										"..." +
										chestEmpower[0].slice(-2)}
								</div>
							</div>
						) : (
							<div>
								<div
									className="friend-avatar text-center"
									disabled={!chestOpenable}
									onClick={chestOpenable ? createEmpower : null}
								>
									+
								</div>
